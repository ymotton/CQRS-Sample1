...
namespace CQRS.Sample1.Process
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchedCollection&lt;T&gt;"/> class.
        /// </summary>
        ...
        {
            if (IsNotifying)
                DispatcherManager.OnUIThread(() => RaisePropertyChangedEventImmediately(new PropertyChangedEventArgs(propertyName)));
        }
        ...
        {
            DispatcherManager.OnUIThread(() => InsertItemBase(index, item));
        }
        ...
        protected sealed override void MoveItem(int oldIndex, int newIndex) {
            DispatcherManager.OnUIThread(() => MoveItemBase(oldIndex, newIndex));
        }
        ...
        {
            DispatcherManager.OnUIThread(() => SetItemBase(index, item));
        }
        ...
        {
            DispatcherManager.OnUIThread(() => RemoveItemBase(index));
        }
        ...
        {
            DispatcherManager.OnUIThread(ClearItemsBase);
        }
